...
//     SNAKE_HEAD : COLORS.LIGHT_ORANGE
// }
// let canvas = document.getElementById("gameScreen");
// let ctx = canvas.getContext("2d");

// ctx.fillStyle = GAME_COLORS.SNAKE_HEAD;
...
function setup(){
   ...
   canvas.style = "position:absolute; left: 30%; width: 40%; margin-left: 0.5%; margin-top: 0.65%";
...
var eatingTargetSound = new sound("eatingTargetSound.wav");
var snakeSound = new sound("snakeSound.wav");
var deathSound = new sound("deathSound.wav");
var gameSoundTrack = new sound("gameSoundTrack.wav");
